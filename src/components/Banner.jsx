      ...
      <div className="container mx-auto flex px-10 lg:py-20 md:flex-row flex-col items center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-6xl text-3x sm:mt-5 font-bold text-gray-100 tracking-wide">
            Finding alignment between your people and your company
          </h1>
          <h1 className="title-font sm:text-6xl sm:mt-5 font-bold text-gray-100 tracking-wide">
          Helping your team one member at a time</h1>
        </div>
